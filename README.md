...
msgpack+zlibパイプラインで伝票作成・印刷・追跡番号取得を提供。
...
- **msgpack+zlib デフォルト**: B2クラウド本来のプロトコルに準拠。JSONフォールバックも対応
...
設計書は [docs/b2cloud-design.md](./docs/b2cloud-design.md) を参照。
ブラウザ実機検証で全パイプライン動作確認済み。
